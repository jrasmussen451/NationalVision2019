...
angular.module('OrderCloud-SpecForms')
    .directive('custommaskfield', ocmaskfield)
...
function ocmaskfield() {
    ...
    function template() {
        return [
            ...
            '<input class="form-control" size="{{customfield.Width * .13}}" ng-maxlength="{{customfield.MaxLength}}" mask="{{customfield.MaskedInput || mask}}" type="text" autocomplete="off" ng-required="{{customfield.Required}}" ng-model="customfield.Value" ng-readonly="customfield.ReadOnly"></input>',
